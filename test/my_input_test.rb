...
class My_inputTest < Minitest::Test 
  ...
  def test_header_1
    my_input = My_input.new
    assert_equal "<h1> This is Header 1.", my_input.header_1
  end
  
  def test_header_2
    my_input = My_input.new
    assert_equal "<h2> This is Header 2.", my_input.header_2
  end

  def test_header_3
    my_input = My_input.new
    assert_equal "<h3> This is Header 3.", my_input.header_3
  end
  
  def test_header_4
    my_input = My_input.new
    assert_equal "<h4> This is Header 4.", my_input.header_4
  end
  
  def test_header_5
    my_input = My_input.new
    assert_equal "<h5> This is Header 5.", my_input.header_5
  end
